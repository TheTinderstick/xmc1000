...
#[doc = "Possible values of the field `ACMP0_SEL`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ACMP0_SELR {
    #[doc = "ACMP0.INP is not connected"]
    VALUE1,
    #[doc = "ACMP0.INP is connected to ACMP1.INP"]
    VALUE2,
}
impl ACMP0_SELR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ACMP0_SELR::VALUE1 => false,
            ACMP0_SELR::VALUE2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> ACMP0_SELR {
        match value {
            false => ACMP0_SELR::VALUE1,
            true => ACMP0_SELR::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline]
    pub fn is_value1(&self) -> bool {
        *self == ACMP0_SELR::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline]
    pub fn is_value2(&self) -> bool {
        *self == ACMP0_SELR::VALUE2
    }
}
#[doc = "Possible values of the field `CMP_LPWR`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CMP_LPWRR {
    #[doc = "High Power Mode"]
    VALUE1,
...
impl CMP_LPWRR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            CMP_LPWRR::VALUE1 => false,
            CMP_LPWRR::VALUE2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> CMP_LPWRR {
        match value {
            false => CMP_LPWRR::VALUE1,
            true => CMP_LPWRR::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline]
    pub fn is_value1(&self) -> bool {
        *self == CMP_LPWRR::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline]
    pub fn is_value2(&self) -> bool {
        *self == CMP_LPWRR::VALUE2
    }
}
...
#[doc = "Values that can be written to the field `ACMP0_SEL`"]
pub enum ACMP0_SELW {
    #[doc = "ACMP0.INP is not connected"]
    VALUE1,
    #[doc = "ACMP0.INP is connected to ACMP1.INP"]
...
impl ACMP0_SELW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ACMP0_SELW::VALUE1 => false,
            ACMP0_SELW::VALUE2 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _ACMP0_SELW<'a> {
    w: &'a mut W,
}
impl<'a> _ACMP0_SELW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: ACMP0_SELW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn value1(self) -> &'a mut W {
        self.variant(ACMP0_SELW::VALUE1)
    }
    #[doc = "ACMP0.INP is connected to ACMP1.INP"]
    #[inline]
    pub fn value2(self) -> &'a mut W {
        self.variant(ACMP0_SELW::VALUE2)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `CMP_LPWR`"]
pub enum CMP_LPWRW {
    #[doc = "High Power Mode"]
    VALUE1,
    #[doc = "Low Power Mode"]
...
impl CMP_LPWRW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            CMP_LPWRW::VALUE1 => false,
            CMP_LPWRW::VALUE2 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _CMP_LPWRW<'a> {
    w: &'a mut W,
}
impl<'a> _CMP_LPWRW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: CMP_LPWRW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn value1(self) -> &'a mut W {
        self.variant(CMP_LPWRW::VALUE1)
    }
    #[doc = "Low Power Mode"]
    #[inline]
    pub fn value2(self) -> &'a mut W {
        self.variant(CMP_LPWRW::VALUE2)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 6 - Connect ACMP0.INP to ACMP1.INP"]
    #[inline]
    pub fn acmp0_sel(&self) -> ACMP0_SELR {
        ACMP0_SELR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u16) != 0
    ...
    #[doc = "Bit 8 - Low Power Mode"]
    #[inline]
    pub fn cmp_lpwr(&self) -> CMP_LPWRR {
        CMP_LPWRR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u16) != 0
...
impl W {
    ...
    #[doc = "Bit 6 - Connect ACMP0.INP to ACMP1.INP"]
    #[inline]
    pub fn acmp0_sel(&mut self) -> _ACMP0_SELW {
        _ACMP0_SELW { w: self }
    }
    #[doc = "Bit 8 - Low Power Mode"]
    #[inline]
    pub fn cmp_lpwr(&mut self) -> _CMP_LPWRW {
        _CMP_LPWRW { w: self }
    }
}
