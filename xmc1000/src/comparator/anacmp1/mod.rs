...
#[doc = "Possible values of the field `REF_DIV_EN`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum REF_DIV_ENR {
    #[doc = "no resistor is connected"]
    VALUE1,
    #[doc = "the divider resistor is enabled and the voltage is applied to ACMP1.INP"]
    VALUE2,
}
impl REF_DIV_ENR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    ...
    pub fn bit(&self) -> bool {
        match *self {
            REF_DIV_ENR::VALUE1 => false,
            REF_DIV_ENR::VALUE2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> REF_DIV_ENR {
        match value {
            false => REF_DIV_ENR::VALUE1,
            true => REF_DIV_ENR::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline]
    pub fn is_value1(&self) -> bool {
        *self == REF_DIV_ENR::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline]
    pub fn is_value2(&self) -> bool {
        *self == REF_DIV_ENR::VALUE2
    }
}
...
#[doc = "Values that can be written to the field `REF_DIV_EN`"]
pub enum REF_DIV_ENW {
    #[doc = "no resistor is connected"]
    VALUE1,
    #[doc = "the divider resistor is enabled and the voltage is applied to ACMP1.INP"]
    VALUE2,
...
impl REF_DIV_ENW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            REF_DIV_ENW::VALUE1 => false,
            REF_DIV_ENW::VALUE2 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _REF_DIV_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _REF_DIV_ENW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: REF_DIV_ENW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn value1(self) -> &'a mut W {
        self.variant(REF_DIV_ENW::VALUE1)
    }
    #[doc = "the divider resistor is enabled and the voltage is applied to ACMP1.INP"]
    #[inline]
    pub fn value2(self) -> &'a mut W {
        self.variant(REF_DIV_ENW::VALUE2)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 6 - Resistor Divider is enabled and Reference Voltage is applied to ACMP1"]
    #[inline]
    pub fn ref_div_en(&self) -> REF_DIV_ENR {
        REF_DIV_ENR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u16) != 0
...
impl W {
    ...
    #[doc = "Bit 6 - Resistor Divider is enabled and Reference Voltage is applied to ACMP1"]
    #[inline]
    pub fn ref_div_en(&mut self) -> _REF_DIV_ENW {
        _REF_DIV_ENW { w: self }
    }
}
